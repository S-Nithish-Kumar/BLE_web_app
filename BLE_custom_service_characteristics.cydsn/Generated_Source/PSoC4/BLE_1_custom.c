...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* LED service */
    {
        0x0010u, /* Handle of the LED service */ 
        {
            ...
            {
                0x0012u, /* Handle of the CONTROL characteristic */ 
            ...
            /* VALUEREAD characteristic */
            {
                0x0014u, /* Handle of the VALUEREAD characteristic */ 
            ...
            /* VALUEREADFLAG characteristic */
            {
                0x0018u, /* Handle of the VALUEREADFLAG characteristic */ 
            ...
            {
                0x001Bu, /* Handle of the FORMDATA characteristic */ 
