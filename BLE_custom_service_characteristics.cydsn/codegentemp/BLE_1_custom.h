...
#define CYBLE_LED_SERVICE_INDEX   (0x00u) /* Index of LED service in the cyBle_customs array */
#define CYBLE_LED_CONTROL_CHAR_INDEX   (0x00u) /* Index of CONTROL characteristic */
#define CYBLE_LED_VALUEREAD_CHAR_INDEX   (0x01u) /* Index of VALUEREAD characteristic */
#define CYBLE_LED_VALUEREAD_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_LED_VALUEREAD_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_LED_VALUEREADFLAG_CHAR_INDEX   (0x02u) /* Index of VALUEREADFLAG characteristic */
#define CYBLE_LED_VALUEREADFLAG_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_LED_FORMDATA_CHAR_INDEX   (0x03u) /* Index of FORMDATA characteristic */
#define CYBLE_LED_FORMDATA_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */


#define CYBLE_LED_SERVICE_HANDLE   (0x0010u) /* Handle of LED service */
#define CYBLE_LED_CONTROL_DECL_HANDLE   (0x0011u) /* Handle of CONTROL characteristic declaration */
#define CYBLE_LED_CONTROL_CHAR_HANDLE   (0x0012u) /* Handle of CONTROL characteristic */
#define CYBLE_LED_VALUEREAD_DECL_HANDLE   (0x0013u) /* Handle of VALUEREAD characteristic declaration */
#define CYBLE_LED_VALUEREAD_CHAR_HANDLE   (0x0014u) /* Handle of VALUEREAD characteristic */
#define CYBLE_LED_VALUEREAD_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0015u) /* Handle of Custom Descriptor descriptor */
#define CYBLE_LED_VALUEREAD_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0016u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_LED_VALUEREADFLAG_DECL_HANDLE   (0x0017u) /* Handle of VALUEREADFLAG characteristic declaration */
#define CYBLE_LED_VALUEREADFLAG_CHAR_HANDLE   (0x0018u) /* Handle of VALUEREADFLAG characteristic */
#define CYBLE_LED_VALUEREADFLAG_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0019u) /* Handle of Custom Descriptor descriptor */
#define CYBLE_LED_FORMDATA_DECL_HANDLE   (0x001Au) /* Handle of FORMDATA characteristic declaration */
#define CYBLE_LED_FORMDATA_CHAR_HANDLE   (0x001Bu) /* Handle of FORMDATA characteristic */
#define CYBLE_LED_FORMDATA_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x001Cu) /* Handle of Custom Descriptor descriptor */
