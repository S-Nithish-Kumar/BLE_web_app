// ======================================================================
// BLE_custom_service_characteristics.v generated from TopDesign.cysch
// 11/17/2023 at 19:10
...
module BLE_v3_66_0 (
	...
	cy_clock_v1_0
		#(.id("6c6d21cc-d80e-410f-90f6-43c4c496ae30/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module ADC_SAR_SEQ_P4_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("1fbf17d1-44ab-487d-8207-e1545ad93fac/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("9d1789ed-5adf-477b-9480-6fbfb5a31c67"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Pot_Output_net;
	wire [0:0] tmpFB_0__Pot_Output_net;
	wire [0:0] tmpIO_0__Pot_Output_net;
	wire [0:0] tmpINTERRUPT_0__Pot_Output_net;
	electrical [0:0] tmpSIOVREF__Pot_Output_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pot_Output
		 (.oe(tmpOE__Pot_Output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pot_Output_net[0:0]}),
		  .analog({Net_173}),
		  .io({tmpIO_0__Pot_Output_net[0:0]}),
		  .siovref(tmpSIOVREF__Pot_Output_net),
		  .interrupt({tmpINTERRUPT_0__Pot_Output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pot_Output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_3 UART_1 (
        ...
        .rx_clk(Net_183),
        .rx_data(Net_184),
        .rx_interrupt(Net_185),
        .tx(Net_186),
        .tx_clk(Net_187),
        .tx_data(Net_188),
        .tx_en(Net_189),
        .tx_interrupt(Net_190));
